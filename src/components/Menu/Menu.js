  ...
  return (
    <div className={"menu" + (props.isOpen ? " menu_visible" : "")} onClick={handleClick} >
      <ul className={"menu__items" + (props.isOpen ? " menu__items_visible" : "")}>
        ...
        <li className="menu__item"><Link to="/" className={"menu__main" + (location === "/"? " menu__main_active" : "")} title="Главная" onClick={props.onClose}>Главная</Link></li>
        <li className="menu__item"><Link to="/movies" className={"menu__link" + (location === "/movies"? " menu__link_active" : "")} title="Фильмы" onClick={props.onClose}>Фильмы</Link></li>
        <li className="menu__item"><Link to="/saved-movies" className={"menu__link" + (location === "/saved-movies"? " menu__link_active" : "")} title="Сохраненные фильмы" onClick={props.onClose}>Сохраненные фильмы</Link></li>
